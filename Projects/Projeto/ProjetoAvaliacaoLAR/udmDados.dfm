object DMDados: TDMDados
  ...
  object FDConnection: TFDConnection
    Params.Strings = (
      'Database=C:\DataBase\AVALIACAOLAR.FDB'
      'User_Name=SYSDBA'
      'Password=masterkey'
      'Server=127.0.0.1'
      'Port=3050'
  ...
  object QPessoa: TFDQuery
    ...
    object QPessoaCPF_CNPJ: TStringField
      FieldName = 'CPF_CNPJ'
      Origin = 'CPF_CNPJ'
    ...
    object QPessoaFL_FISICA_JURIDICA: TBooleanField
      FieldName = 'FL_FISICA_JURIDICA'
      Origin = 'FL_FISICA_JURIDICA'
    end
  end
  object QProduto: TFDQuery
    ...
    object QProdutoPRECO: TFMTBCDField
      FieldName = 'PRECO'
      Origin = 'PRECO'
      DisplayFormat = '#,##0.00'
      Precision = 18
  ...
  object QPedido: TFDQuery
    ...
    object QPedidoID_PESSOA: TIntegerField
      FieldName = 'ID_PESSOA'
      Origin = 'ID_PESSOA'
    end
    ...
    object QPedidoTOTAL: TFMTBCDField
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
      DisplayFormat = '#,##0.00'
      Precision = 18
  ...
  object QPedidoItem: TFDQuery
    ...
    UpdateOptions.AssignedValues = [uvFetchGeneratorsPoint, uvGeneratorName]
    UpdateOptions.FetchGeneratorsPoint = gpImmediate
    UpdateOptions.GeneratorName = 'GEN_PEDIDO_ITEM_ID'
    UpdateOptions.KeyFields = 'ID'
    UpdateOptions.AutoIncFields = 'ID'
    SQL.Strings = (
    ...
    object QPedidoItemID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object QPedidoItemID_PRODUTO: TIntegerField
      FieldName = 'ID_PRODUTO'
      Origin = 'ID_PRODUTO'
    end
    object QPedidoItemQUANTIDADE: TFMTBCDField
    ...
    object QPedidoItemPRECO_UNITARIO: TFMTBCDField
    ...
    object QPedidoItemUNIDADE: TStringField
      FieldName = 'UNIDADE'
      Origin = 'UNIDADE'
    end
    object QPedidoItemTOTAL: TFMTBCDField
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
      DisplayFormat = '#,##0.00'
      Precision = 18
